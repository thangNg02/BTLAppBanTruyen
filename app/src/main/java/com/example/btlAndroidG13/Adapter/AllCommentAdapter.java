...
public class AllCommentAdapter extends RecyclerView.Adapter<AllCommentAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull @NotNull ViewHolder holder, int position) {
        ...
        holder.tvTimeBinhluanAll.setText(binhluan.getTimenow());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private TextView tvNameDongAllCmt, tvNoidungDongAllCmt, tvTimeBinhluanAll;
        ...
        public ViewHolder(@NonNull @NotNull View itemView) {
            ...
            tvTimeBinhluanAll = itemView.findViewById(R.id.tv_time_binhluan_all);
        }
    }
}
