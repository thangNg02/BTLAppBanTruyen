...
public class BinhLuanAdapter extends RecyclerView.Adapter<BinhLuanAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull @NotNull ViewHolder holder, int position) {
        ...
        holder.tvTimeBinhluan.setText(binhluan.getTimenow());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private TextView tvBinhLuan, tvRate, tvNameBinhLuan, tvTimeBinhluan;
        public ViewHolder(@NonNull @NotNull View itemView) {
            ...
            tvTimeBinhluan = itemView.findViewById(R.id.tv_time_binhluan);
        }
    }
}
